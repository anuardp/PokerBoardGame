...
[TestFixture]
public class Game_IsFoldedPlayerHaveFolded
{
    private Game _game;
    [SetUp]
    public void Setup()
    ...
    [Test]
    public void IsFolded_PlayerFolded_ReturnTrue()
    {
        List<IPlayer> players = new List<IPlayer>();
        players.Add(new Player("1", "A", "human"));
        players.Add(new Player("2", "B", "human"));
        players.Add(new Player("3", "C", "human"));
        players.Add(new Player("4", "D", "human"));
        Dictionary<IPlayer, bool>? playerFolded = new Dictionary<IPlayer, bool>();
        ...
        Assert.That(playerFolded[currentPlayer],  Is.True, $"Pemain {currentPlayer.Name} telah fold" );
    }
    [Test]
    public void IsFolded_PlayerNotFolded_ReturnFalse()
    {
        List<IPlayer> players = new List<IPlayer>();
        players.Add(new Player("1", "A", "human"));
        players.Add(new Player("2", "B", "human"));
        ...
        Assert.That(playerFolded[currentPlayer],  Is.False, $"Pemain {currentPlayer.Name} telah fold" );
    }
}
