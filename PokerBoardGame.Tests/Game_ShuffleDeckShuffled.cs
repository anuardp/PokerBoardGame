...
[TestFixture]
public class Game_ShuffleDeckShuffled
{
    private Game _game;
    [SetUp]
    public void Setup()
    ...
    [Test]
    public void ShuffleDeck_DeckIsNowShuffled()
    {
        ...
        List<ICard> deckAfterShuffle = deck;
        _game.ShuffleDeck(deckAfterShuffle);
        Assert.That(deck.SequenceEqual(deckAfterShuffle), Is.True, "Deck cards has already got shuffled" );
    }
}
