...
[TestFixture]
public class Game_ResetBoardShould
{
    private Game _game;
    [SetUp]
    public void Setup()
    ...
    [Test]
    public void ResetBoard_DoesBoardGetReset()
    {
        //Simulasi 
        GamePhase phase = GamePhase.PreFlop;
        List<ICard>? board = _game.GetBoard();
        
        while(phase != GamePhase.Showdown)
        {
        ...
        Assert.That(prevCards != currentCards, Is.True, "Board is already reset" );
    }
}
