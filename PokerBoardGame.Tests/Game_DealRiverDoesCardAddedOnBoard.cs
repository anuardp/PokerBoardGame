...
[TestFixture]
public class Game_DealRiverDoesCardAddedOnBoard
{
    private Game _game;
    [SetUp]
    public void Setup()
    ...
    [Test]
    public void DealRiver_DealOneCardsOnBoard()
    {
        ...
        Assert.That(currentCards == 4, Is.True, $"Satu kartu tambahan sudah ditambah pada fase {phase}");   
    }
